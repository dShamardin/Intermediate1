...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            ;
            if (ld.getMonth().equals(Month.MARCH) || ld.getMonth().equals(Month.APRIL) ||
                    ld.getMonth().equals(Month.MAY)) {
                ld.plusWeeks(1);
                System.out.print(ld.plusWeeks(1) + " ");
                cactus.WaterCactuc();
            }
            ;
            if (ld.getMonth().equals(Month.JUNE) || ld.getMonth().equals(Month.JULY) ||
                    ld.getMonth().equals(Month.AUGUST)) {
            ...
            } else if(ld.getMonth().equals(Month.SEPTEMBER) || ld.getMonth().equals(Month.OCTOBER) ||
                    ld.getMonth().equals(Month.NOVEMBER)) {
                ld.plusWeeks(1);
                System.out.print(ld.plusWeeks(1) + " ");
                cactus.WaterCactuc();
            }
